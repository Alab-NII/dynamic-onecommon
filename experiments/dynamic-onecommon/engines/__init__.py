...
class EngineBase(object):
    ...
    def train_batch(self, batch):
        lang_loss, sel_loss, sel_correct, sel_predict, _ = self._forward(batch)
    ...
    def test_batch(self, batch):
        with torch.no_grad():
            lang_loss, sel_loss, sel_correct, sel_predict, batch_output = self._forward(batch)

        return lang_loss.item(), sel_loss.item(), sel_correct, sel_predict, batch_output
